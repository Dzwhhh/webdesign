...
import (
	...
	testdata "github.com/demian/webdesign/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/demian/webdesign/framework/gin.handlerNameTest$", c.HandlerName())
}
